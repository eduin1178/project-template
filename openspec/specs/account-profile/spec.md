...
Perfil del usuario en `/account/profile`. Permite editar datos básicos, cambiar/establecer contraseña, y vincular/desvincular cuentas (Google y credencial) con guardrail anti-lockout. Aplica a cualquier rol (super_admin, admin, user).
