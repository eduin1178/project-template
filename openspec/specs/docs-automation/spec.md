# docs-automation Specification

## Purpose

Workspace local de automatización con Playwright que captura screenshots y verifica regresiones de la documentación a partir de un manifest YAML por chunk. Opera únicamente en local (sin CI) y permanece aislado de `next-app/` y `docs-app/`.
