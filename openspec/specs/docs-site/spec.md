...
Sitio de documentación pública construido con Fumadocs como aplicación Next.js independiente bajo `docs-app/`, desacoplada de `next-app/`. Mantiene coherencia visual con la marca sin acoplamiento, copy en español neutral, contenido organizado por chunks lógicos y features AI scaffoldeadas pero dormidas, con build estándar de Next.js.
