...
Landing page pública en `/` para Docentix — primer punto de contacto comercial de la plataforma de gestión de tareas docentes, dirigida a instituciones educativas (decisores y docentes). Define estructura, contenido, formulario de solicitud de demo y comportamiento del CTA de acceso reactivo al estado de autenticación.
