...
Integración con Cloudflare R2 vía un módulo server-only que expone primitivas de upload/delete para assets públicos (por ejemplo, logos de organización). El módulo es agnóstico al dominio: los callers validan MIME y tamaño antes de invocar.
