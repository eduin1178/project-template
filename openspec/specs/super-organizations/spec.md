...
El sistema SHALL exponer `app/super/(protected)/organizations/[id]/page.tsx` que renderice un header con `name`, `slug`, fecha de creación y dos tabs: "Miembros" e "Invitaciones".
