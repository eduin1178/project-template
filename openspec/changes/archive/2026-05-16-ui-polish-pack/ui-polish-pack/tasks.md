...
- [x] Z1 Confirmar que los tres bloques pueden mergearse independientemente (sin imports cruzados accidentales)
- [x] Z2 Si el tamaño total del diff supera 400 líneas, coordinar con el delivery strategy del repo: chained PRs (uno por bloque) o `size:exception` documentado
