...
export function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div
        aria-hidden
        className="absolute inset-0 -z-10 opacity-[0.25] [background-image:radial-gradient(var(--color-border)_1px,transparent_1px)] [background-size:24px_24px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_0%,#000_40%,transparent_100%)]"
      />
